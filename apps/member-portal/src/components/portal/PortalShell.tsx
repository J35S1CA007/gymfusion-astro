...
type PortalShellProps = { active: PortalSection; children: React.ReactNode; member: PortalMember; onLogout?: () => void; logoutHref?: string; eyebrow?: string; title?: string; description?: string; compact?: boolean };
...
export default function PortalShell({ active, children, member, onLogout, logoutHref, eyebrow = "GYMFUSION MEMBERS PORTAL", title, description, compact = false }: PortalShellProps) {
